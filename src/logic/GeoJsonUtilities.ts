...
export class GeoJsonUtilities {
    ...
    public static calculateDistance(pos1: any, pos2: any): number {
    ...
    public static calculateBearing(pos1: any, pos2: any): number {
    ...
    public static simplify(source: any[], kink?: number): any[] { /* source[] array of geojson points */
    ...
    public static simplify1(source: any[], kink?: number): any[] { /* source[] array of geojson points */
        /* kink	in metres, kinks above this depth kept  */
        /* kink depth is the height of the triangle abc where a-b and b-c are two consecutive line segments */
        kink = kink || 20;
    ...
    private static calculatePerpendicularDistance(point1, point2, point3): number {
        let point = {
    ...
    public static simplifyGeometry(points, tolerance) {
        let dmax = 0;
        let index = 0;
    ...
    public static simplifyPath(positions: any[], shortDistance: number,
        longDistance: number, longAngle: number): any[] {
